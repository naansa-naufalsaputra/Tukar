...
class UXAuditor:
    ...
    def audit_file(self, filepath: str) -> None:
        ...
        has_form = not filename.endswith('.css') and bool(re.search(r'<form|<input|<TextInput|password|credit|payment', content, re.IGNORECASE))
        ...
        # Familiar patterns
        if has_form:
            has_standard_labels = bool(re.search(r'<label|placeholder|aria-label|accessibilityLabel', content, re.IGNORECASE))
