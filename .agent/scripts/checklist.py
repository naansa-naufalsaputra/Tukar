...
def print_header(text: str):
    # Strip emojis for compatibility with non-UTF8 terminals
    safe_text = text.encode('ascii', 'ignore').decode('ascii').strip()
    print(f"\n{Colors.BOLD}{Colors.CYAN}{'='*60}{Colors.ENDC}")
    print(f"{Colors.BOLD}{Colors.CYAN}{safe_text.center(60)}{Colors.ENDC}")
...
def print_summary(results: List[dict]):
    ...
    print(f"{Colors.RED}[ERR] Failed: {failed_count}{Colors.ENDC}")
